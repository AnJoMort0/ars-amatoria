...
…Gosh, that was weird.`, 
            ...
            'look_at_friends': [
                `They’re standing in a loose circle, chatting easily, their laughter blending into the hum of the corridor.

One of them, the girl with glasses, gestures animatedly as she talks, her voice carrying just a bit louder than the rest. She seems like the imposing one—and that physically as well. Next to her, another girl, short hair, sharp eyes, nods along, but her smirk suggests she’s only half-listening. The last one, standing a little closer to Jessica, tilts her head as she listens, twirling the drawstring of her hoodie absentmindedly. She looks like the quieter one, the one who doesn’t always speak up but never really misses anything.

I don’t know why I’m watching them. Studying them.
Then, suddenly, I realize...they’re looking back.

The chunky girl with glasses squints slightly. Short-hair is oblivious. Hoodie-girl glances at Jessica, then back at me.
...
Crap. I should probably do something.`, 
                ...
                [
                    `Analysing the Group`,
                    `Look at the friends`,
                    `You analyse the girl's friends. However, they notice you are staring.`,
                ],
            ],
                'run_on_look': [
                    `I freeze.
They’re looking at me. THEY'RE LOOKING AT ME!
My brain shuts down. Just pure, unfiltered panic.
So I do the only thing that makes sense.

I RUN!
Not a casual turn-and-walk. A full, desperate sprint in the opposite direction.
And then—because the universe isn’t done with me—my foot catches on the floor, and before I can even process what’s happening, I’m airborne.

I hit the ground hard. A painful smack of skin on tile.
The corridor erupts. Laughter, gasps, whispers—somewhere, someone half-heartedly asks if I’m okay, but they’re already laughing before they finish the sentence.
Face burning, I scramble to my feet and keep running, not daring to look back.
I don’t stop until I’m around a corner, out of sight, heart pounding, breath ragged.
...
What the hell was that?`, 
                ...
                'wave_on_look': [
                    `I raise a hand and wave. Friendly. Casual. It’s all about the confidence.
I take a step forward, then another. Keep it natural. I approach the group, flashing a polite smile.
"Hey, sorry—I think I also saw you in the exam?"

It’s an easy icebreaker. The conversation unfolds effortlessly from there. Someone groans about the test. Someone else jokes about completely making up an answer. We laugh. It’s light, natural. Enjoyable.
At first, I’m talking to all of them. But gradually, my focus shifts—to her.

She comments on a question, and I respond. She laughs at something I say, and I direct the next part toward her. The others are still there, still talking, but they fade into the background. The conversation is flowing now, and it’s ours.

I can't screw this over now.`, 
                    [
                        ['joke','gr_joke'],
                    ...
                    [
                        `Friendly Wave`,
                        `Wave at the friend group`,
                        `You wave at the girl and her friends, and the conversation goes smoothly.`,
                    ],
                ],
                    'gr_joke': [
                        `The conversation is smooth, effortless. Her smile feels like it's burning itself into my brain.
I toss out a few jokes—small things, playful, just enough to make her blush, to make her laugh in that soft, sweet way. This is going perfectly.

But then, it happens.
Just as we’re locking in, the chunky girl with the glasses steps in. Not just inserting herself into the conversation—physically stepping between us, cutting off the flow. She throws me a cold look. The conversation is hers now.

I feel something twist in my chest. The moment is slipping. I need to take control back.
I smirk, straighten my posture, and say just loud enough for everyone to hear:
"It’s always the fridge protecting the snacks, huh?"

The air shifts. The girl’s smile vanishes. The group goes quiet. Glasses-girl’s expression doesn’t even change, just a long, slow blink.
I can feel it immediately—wrong move.

Right. Maybe don’t insult the best friend.
Noted.`, 
                        [],
                        e,
                        [
                            `Wrong Joke`,
                            `Joke`,
                            `When the girl's friend steps between you and her, you attack her physically, calling her "a fridge".`,
                        ],
...
She seems to notice.
As the conversation flows, her eyes meet mine more often. Her smile lingers a little longer. Then, almost casually, she says,
"My name’s Jessica, by the way."

Something catches in my throat. I wasn’t expecting that.
"I—uh, I’m Sam."
The words stutter out, but she doesn’t seem to mind.
...
She shifts her bag over her shoulder.
"Cool. Mind if I keep you company for a bit?"

For a second, I don’t move. I just let the moment settle in.
Then, I nod.
"Yeah. That’d be nice."

We head outside, the conversation light but comfortable, and for the first time, I feel like I’m actually connecting with her.
...
Just talking.`, 
                        ...
                        [
                            ...
                            `Smile`,
                            `You go along with the conversation and Jessica opens herself to you.`,
                        ],
